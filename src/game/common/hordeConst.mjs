...
export const MONSTER_TYPES = {
  ...
  sergeant: {
    ...
    weapon: {
      ...
      damage: [22, 19],
      hit_chance: [0.9, 0.8],
      critical_hit_chance: [0.2, 0.15],
      critical_hit_multiplier: [1.8, 1.5],
    },
  ...
  captain: {
    ...
    weapon: {
      attack_range: 3,
      damage: [30, 25, 20],
      hit_chance: [0.85, 0.8, 0.75],
      critical_hit_chance: [0.18, 0.16, 0.14],
      critical_hit_multiplier: [1.8, 1.6, 1.4],
    },
  ...
  major: {
    ...
    weapon: {
      attack_range: 3,
      damage: [35, 30, 25],
      hit_chance: [0.9, 0.9, 0.8],
      critical_hit_chance: [0.2, 0.19, 0.17],
      critical_hit_multiplier: [1.9, 1.7, 1.4],
    },
  ...
  colonel: {
    ...
    weapon: {
      attack_range: 4,
      damage: [45, 40, 35, 30],
      hit_chance: [0.9, 0.85, 0.8, 0.75],
      critical_hit_chance: [0.2, 0.18, 0.16, 0.14],
      critical_hit_multiplier: [2.0, 1.8, 1.6, 1.4],
    },
